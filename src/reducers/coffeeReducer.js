...
const initialState = [
  {
    ...
    description: 'Grown on the Rante Karua mountain range in S.W. Sulawesi. The beans are hand picked and sun dried. The coffee produces a heavy smooth liquor and a rich flavour.',
  },
  {
    id: 2,
    name: 'Old Brown Java',
    ...
    description: 'Accidentally "invented" when this Javanese coffee was used as ballast in trading cutters on their way to the New World. The coffee matured with the bean changing colour from a light green to pale brown. This results in the loss of some acidity and an enhanced, heavy body and sweetness. This coffee is left for two years to mature these days.',
  },
  {
    id: 3,
    ...
    flavour: 'RICH & NUTTY',
    description: 'Produced in the mountainous Eastern Highlands where the soil is rich and dark in colour with volcanic origins. The coffee is produced by traditional methods, the trees have never seen chemical fertilizers or pesticides. The coffee has a chocolate, nutty flavour with a slightly fruity finish.',
  },
];
